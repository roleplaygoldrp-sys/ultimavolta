...
// Validate ../../app/api/generate-funnel/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/generate-funnel">> = Specific
  const handler = {} as typeof import("../../app/api/generate-funnel/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
